...
export default function DashboardPage() {
  ...
  }, [user?.uid, loading, LATE_THRESHOLD, ABSENT_THRESHOLD, setError, setHasCheckedInToday, setHasCheckedOutToday, setLastCheckIn, setLoading]);
  ...
  // Fix handleCheckIn type
  const handleCheckIn = async () => {
    if (!user?.uid || isProcessing || !firebaseDb) return;
